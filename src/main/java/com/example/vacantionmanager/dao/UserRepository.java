...
import com.example.vacantionmanager.model.Role;
    ...
    public Integer insertUser(User user) {
        try {
            ...
            if (user.getRole() == null) {
                ...
                return entityManager.createNamedQuery("insertUser").setParameter(1, user.getUsername()).
                        setParameter(2, user.getPassword().getBytes(StandardCharsets.UTF_8))
                        .setParameter(3, user.getFirstName()).
                        setParameter(4, user.getLastName()).
                        setParameter(5, user.getCompanyName()).
